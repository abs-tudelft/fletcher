...
begin
  ...
  begin
    ...
    dumpStdOut("Return register 0: " & ii(u(read_data)));
    mmio_read(REG_RETURN1, read_data, mmio_source, mmio_sink);
    dumpStdOut("Return register 1: " & ii(u(read_data)));
