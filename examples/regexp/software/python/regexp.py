...
if __name__ == "__main__":
    ...
    for e in range(ne):
        ...
        print("Python list on CPU (re): " + str(sum(t_py_pyre)/(i+1)))
        print("Pandas series on CPU (re): " + str(sum(t_pa_pyre)/(i+1)))
        print("Python list on CPU (Pyre2): " + str(sum(t_py_pyre2)/(i+1)))
        print("Pandas series on CPU (Pyre2): " + str(sum(t_pa_pyre2)/(i+1)))
        print("Arrow array on CPU (Pyre2): " + str(sum(t_ar_pyre2)/(i+1)))
        print("Arrow array on CPU (CPP Re2): " + str(sum(t_ar_cppre)/(i+1)))
        print("Arrow array on CPU (CPP Re2 OMP): " + str(sum(t_ar_cppre_omp)/(i+1)))
        print("Arrow array to FPGA copy: " + str(sum(t_copy)/(i+1)))
        print("Arrow array on FPGA algorithm time: " + str(sum(t_fpga)/(i+1)))
        print("Arrow array on FPGA total: " + str(sum(t_ftot)/(i+1)))
