...
a temporary directory it creates by default. This is required because the memory models for simulation are supplied 
with path relative to where Fletchgen was run.
