...
file copy -force $FLETCHER_EXAMPLES_DIR/stringwrite/hardware/UTF8StringGen.vhd        $TARGET_DIR
file copy -force $FLETCHER_EXAMPLES_DIR/stringwrite/hardware/stringwrite_pkg.vhd      $TARGET_DIR
file copy -force $FLETCHER_EXAMPLES_DIR/stringwrite/hardware/stringwrite_usercore.vhd $TARGET_DIR
file copy -force $FLETCHER_EXAMPLES_DIR/stringwrite/hardware/stringwrite_wrapper.vhd  $TARGET_DIR
file copy -force $FLETCHER_EXAMPLES_DIR/stringwrite/hardware/axi_top.vhd              $TARGET_DIR
