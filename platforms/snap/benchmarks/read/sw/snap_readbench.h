...
#define REG_BURST_LENGTH SNAP_OFFSET + 4*2
#define REG_MAX_BURSTS   SNAP_OFFSET + 4*3
#define REG_BASE_ADDR_LO SNAP_OFFSET + 4*4
#define REG_BASE_ADDR_HI SNAP_OFFSET + 4*5
#define REG_ADDR_MASK_LO SNAP_OFFSET + 4*6
#define REG_ADDR_MASK_HI SNAP_OFFSET + 4*7
#define REG_CYCLES       SNAP_OFFSET + 4*8
#define REG_CHECKSUM     SNAP_OFFSET + 4*9
